...
const serviceOptions: ServiceCategory[] = [
  {
    ...
    options: [
      ...
      },
      {
        ...
        image: "/images/services/premium-mixing.jpg",
        icon: PlusIcon
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        image: "/images/services/premium-mastering.jpg",
        icon: PlusIcon
      }
    ]
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        image: "/images/services/full-production.jpg",
        icon: UserGroupIcon
      }
    ]
  }
  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto py-16 px-4">
        ...
        <p className="text-lg text-white/80 mb-12">Select services or products and purchase securely.</p>
        
        <div>
          {/* Category Tabs with Icons */}
          <div className="flex flex-wrap mb-8 border-b border-white/10">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12">
            {serviceOptions
              .find(category => category.id === activeCategory)?.options
              .map(service => {
                ...
                return (
                  <div key={service.id} className="bg-gray-900 p-6 rounded-lg border border-white/10 hover:border-accent/50 transition-colors">
                    ...
                    {/* Traditional Snipcart button with data attributes */}
                    <button
                      className="snipcart-add-item w-full py-2 bg-accent text-black rounded-md font-medium hover:bg-accent/90 transition flex items-center justify-center"
          ...
          <div className="mt-8 bg-gray-900 p-6 rounded-lg">
            ...
            <div className="flex justify-center">
              <a 
                href="/contact" 
                className="inline-flex items-center px-6 py-3 bg-accent text-black font-semibold rounded-md hover:bg-accent/90 transition"
              >
