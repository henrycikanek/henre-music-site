        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <Link 
              ...
              className="block bg-gray-900 p-6 rounded-lg hover:bg-gray-800 transition duration-300 group cursor-pointer text-center"
            >
              <div className="mb-4 text-accent group-hover:scale-110 transform transition duration-300 flex justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-3c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zM9 10l12-3" />
                </svg>
              </div>
              <h3 className="text-xl font-bold group-hover:text-accent transition duration-300">Mixing</h3>
            </Link>
            ...
            >
              ...
              <h3 className="text-xl font-bold group-hover:text-accent transition duration-300">Mastering</h3>
            </Link>
            ...
            >
              ...
              <h3 className="text-xl font-bold group-hover:text-accent transition duration-300">Production</h3>
            </Link>
            ...
            >
              ...
              <h3 className="text-xl font-bold group-hover:text-accent transition duration-300">Vocal Engineering</h3>
            </Link>
          </div>
        </div>
      </section>
